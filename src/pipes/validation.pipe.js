    ...
    ValidationPipe.prototype.transform = function (value, metadata) {
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        obj = (0, class_transformer_1.plainToClass)(metadata.metatype, value);
                        return [4 /*yield*/, (0, class_validator_1.validate)(obj)];
                    case 1:
                        errors = _a.sent();
                        console.log(errors);
                        if (errors.length) {
                            messages = errors.map(function (err) {
                                return "".concat(err.property, " - ").concat(Object.values(err.constraints).join(','));
                            });
